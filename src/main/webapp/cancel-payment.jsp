  ...
  <body>
    ...
    <section class="home" id="home">
      <div class="content">
        ...
        <p>
            ABC Restaurant is a renowned dining chain in Sri Lanka, offering a variety of fresh, delicious dishes. They focus on combining traditional flavors with modern dining experiences, creating memorable experiences for all. They are continuously innovating and expanding their services, with a new web-based application for easy reservations and menu exploration.
        </p>
    ...
    <section class="speciality" id="speciality">
        ...
        <div class="box-container">
          <div class="box">
            <img src="img/open-kitchen.jpg" alt="" class="image" />
            <div class="content">
              <img src="img/s-6.png" alt="" />
              <h3>Open kitchen front house</h3>
              <p>
                Open kitchens can provide customers with direct access to 
                information about an establishment's hygiene, professionalism and culinary excellence.
              </p>
            </div>
          </div>
  
          <div class="box">
            <img src="img/barlunch.jpg" alt="" class="image" />
            <div class="content">
              <img src="img/s-6.png" alt="" />
          ...
          <div class="box">
            <img src="img/live.jpg" alt="" class="image" />
            <div class="content">
              <img src="img/s-6.png" alt="" />
          ...
          <div class="box">
            <img src="img/meetin.jpg" alt="" class="image" />
            <div class="content">
              <img src="img/s-6.png" alt="" />
          ...
          <div class="box">
            <img src="img/private.jpg" alt="" class="image" />
            <div class="content">
              <img src="img/s-6.png" alt="" />
              <h3>Private dining <area shape="" coords="" href="" alt=""></h3>
              <p>
     ...
     <section class="footer">
        ...
        <h1 class="credit">
          created by <span>Chamal Harsha</span> | All rights reserved
        </h1>
      </section>
      <!-- footer section ends -->
